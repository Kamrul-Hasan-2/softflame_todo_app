...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'otp_instruction': 'Please enter your 4-digit verification code sent to:',
    ...
    'bn': {
      ...
      'welcome': 'স্বাগতম!',
      'please_sign_in':
          'অনুগ্রহ করে আপনার অ্যাকাউন্ট অ্যাক্সেস করতে সাইন ইন করুন বা সাইন আপ করুন.',
      ...
      'otp_instruction':
          'অনুগ্রহ করে আপনার কাছে পাঠানো 4-সংখ্যার যাচাইকরণ কোড লিখুন:',
      'verification_code': 'যাচাইকরণ কোড',
      'didnt_receive_code': 'কোড পাননি?',
      'resend_in': 'আবার পাঠান',
      'resend_timer': '{{seconds}} সেকেন্ডের মধ্যে',
  ...
  String get otpInstruction => translate('otp_instruction');
  ...
  String resendTimerText(int seconds) {
    return translate('resend_timer').replaceAll(
      '{{seconds}}',
      localizedNumber(seconds),
    );
  }
  ...
  String localizedNumber(int value) {
    ...
    return value.toString().split('').map((digit) {
      ...
      return index == -1 ? digit : banglaDigits[index];
    }).join();
  }
